...
// klik.addEventListener('click', () => {console.log(klik.value)});
...
// Konfigurasi bagian Zodiak

let resultZodiak = document.querySelector('.zodiak > h2');
let inputBln = document.querySelector('.bulan');
let inputTgl = document.querySelector('.tanggal');
let btnZodiak = document.querySelector('.zodiak > button');

resultZodiak.style.backgroundColor = 'white';

btnZodiak.addEventListener('click', function() {
	let bulan = Number(inputBln.value);
	let tanggal = Number(inputTgl.value);
	resultZodiak.innerHTML = zodiak(bulan,tanggal);
});

// Konfigurasi bagian Zodiak

let resultPredikat = document.querySelector('.predikat > h2');
let inputNilai = document.querySelector('.nilai');
let btnPredikat = document.querySelector('.predikat > button');

resultPredikat.style.backgroundColor = 'white';

btnPredikat.addEventListener('click', function() {
	let nilai = Number(inputNilai.value);
	resultPredikat.innerHTML = predikatNilai(nilai);
});

// Konfigurasi bagian Zodiak

let resultPrima = document.querySelector('.prima > h2');
let inputBilangan = document.querySelector('.bilangan');
let btnPrima = document.querySelector('.prima > button');

resultPrima.style.backgroundColor = 'white';

btnPrima.addEventListener('click', function() {
	let angka = Number(inputBilangan.value);
	resultPrima.innerHTML = prima(angka);
});

// Konfigurasi bagian Zodiak

let resultTerbilang = document.querySelector('.terbilang > h2');
let inputAngka = document.querySelector('.angka');
let btnTerbilang = document.querySelector('.terbilang > button');

resultTerbilang.style.backgroundColor = 'white';

btnTerbilang.addEventListener('click', function() {
	let angka = Number(inputAngka.value);
	resultTerbilang.innerHTML = terbilang(angka);
});